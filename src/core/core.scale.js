...
module.exports = Element.extend({
    ...
    // Get the correct value. NaN bad inputs, If the value type is object get the x or y based on whether we are
    // horizontal or not
    ...
    draw: function (chartArea) {
        ...
        helpers.each(ticks, function (tick, index) {
            ...
            if (isHorizontal) {
                ...
                labelX = me.getPixelForTick(index) + optionTicks.labelOffset; // x values for optionTicks (need to
                                                                              // consider offsetLabel option)
